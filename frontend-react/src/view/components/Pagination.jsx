export const PaginationEl = ({ generatePageNumbers, paginatePage, setPaginatePage, paginateTotalPage, paginateTotalItem }) => {
    const LINK_PAGEINATE_ACTIVE = "z-10 flex items-center justify-center px-4 h-10 leading-tight text-blue-600 border border-blue-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700 "
    const LINK_PAGINATE_DEACTIVE = "flex items-center justify-center px-4 h-10 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 "
    ...
    return (
        <div className="py-5 flex justify-between items-center">
            ...
            <div>Total : {paginateTotalItem}</div>
        </div>
    )
